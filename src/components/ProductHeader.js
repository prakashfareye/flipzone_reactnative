...
const ProductHeader = (props) => {
    ...
    searchPress = () => {
        ...
        .catch(error => console.log("searchBarPress for header AsyncStorage error"));
    }
    ...
    return (
        <View style={styles.searchBar}>
            ...
            <View style={{width: 150, flexdirection: "row", alignSelf: "center", height: 30}}>
                    <Text numberOfLines={1} style={{color: "black", fontWeight: 'bold'}}>{props.title ? props.title : ""}</Text>
